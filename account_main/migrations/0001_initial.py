# Generated by Django 3.1.1 on 2020-10-11 06:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_uid', models.AutoField(primary_key=True, serialize=False, verbose_name='Идентификатор пользователя')),
                ...
                ('username', models.CharField(default='', max_length=255, verbose_name='Полное имя пользователя')),
                ('birthday', models.DateField(blank=True, null=True, verbose_name='Дата рождения')),
                ('email', models.EmailField(default='нет электронной почты', max_length=254, verbose_name='Дата рождения')),
